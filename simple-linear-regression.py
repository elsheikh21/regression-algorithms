...
# can plot each of these features:
...
# Linear Regression fits a linear model with coefficientsB = (B1, ..., Bn)
# to minimize the 'residual sum of squares' between the independent
# x in the dataset, and the dependent y by the linear approximation.

# Modeling
# Coefficient and Intercept in the simple linear regression,
# are the parameters of the fit line.
...
# Notice that all of the data must be available
...
# development of a model, as it provides insight to areas
...
# This is the easiest of the metrics to understand since
# it’s just average error.
# - Mean Squared Error (MSE): Mean Squared Error (MSE) is the mean of the
# squared error. It’s more popular than Mean absolute error because the focus
# is geared more towards large errors. This is due to the squared term
